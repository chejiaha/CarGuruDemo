...
# print("infoDict Keys %s" % info_dict[make][model].keys())

# # Get the list of trims for the model so we can add each avg to the amount
# trims = info_dict[make][model].keys()
# print(trims)
# # 4. Get the Price of Each Vehicle.
# #There is a chance that there is only msrp, so we will only use the msrp car prices to keep consistancy
# all_spec_html = driver.find_elements_by_class_name("card__price")
