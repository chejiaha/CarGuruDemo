...
public class DisplayCategoryCarsActivity extends AppCompatActivity {

    ArrayList<CarModel> cars;
    Intent intent;
    TextView categoryLbl;
    ListView listView;
    Context context;
    ArrayAdapter carArr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_category_cars);

        intent = getIntent();
        // setting the values for the UI controls
        categoryLbl = findViewById(R.id.lblCategory);
        listView = findViewById(R.id.category_cars_list);
        context = this;
        ...
        ValueEventListener listener = reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                */
                ...
                carArr = new ArrayAdapter<String>(context, android.R.layout.simple_list_item_1, carModels);
