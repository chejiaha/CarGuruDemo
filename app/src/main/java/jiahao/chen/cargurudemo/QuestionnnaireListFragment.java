...
//THIS CLASS IS TO BE DELETED ONCE WE GET A MAIN LIST PAGE.
public class QuestionnnaireListFragment extends Fragment {

    public QuestionnnaireListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_questionnnaire_list, container, false);
